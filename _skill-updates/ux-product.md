...
```
App open → 30-day trial start screen (countdown visible) →
...
| 6 | Jun 2026 | Trial 7→30 days — hard countdown retained, no soft gates. Warranty wording rule: "keeps the records warranties require", never imply claim approval is guaranteed | Trial UX, copy |
